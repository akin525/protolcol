        ...
        <div class="card">
            <div class="card-body met-pro-bg">
                <div class="met-profile" >
                    <div class="row" style='background-image: url("/admin/images/pattern.png"); padding: 20px; color: white'>
                        <div class="col-lg-4 align-self-center mb-3 mb-lg-0">
                            <div class="met-profile-main">
                                <div class="met-profile-main-pic">
                                    ...
                                    @else
                                        <img alt="image" class="img img-thumbnail" width="200" src="{{asset("po.jpg")}}">
                                    @endif
